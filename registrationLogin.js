...
userRouter.get('/dashboard',auth.checkLogin,function(req,res){
    ...
    // res.redirect('/users/+'newUser.userName'+/info')
  ...
  userRouter.get('/Contact',function(req,res){
        ...
        res.render('Contact.html' , {root: './views'});

    });
 userRouter.get('/products',auth.checkLogin,function(req,res){
      console.log("user redirect")
     res.render('products.html' , {root: './views'});
...
newUser.save(function(err, result){
    if(err){
        ...
        // res.redirect('/users/+'userName'+/info')
         // res.render('./../views/dashboard' , {userName : newUser.userName , email : newUser.email})
